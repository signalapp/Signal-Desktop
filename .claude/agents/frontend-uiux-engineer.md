...
## Source of Truth
**Primary Reference:** [PRODUCT-REQUIREMENTS-DOCUMENT.md](/orbital-docs/PRODUCT-REQUIREMENTS-DOCUMENT.md)
...
- **Remove:** 1:1 chat UI, stories, calling interfaces, payment UI
- **Keep:** Media display components (video player, image gallery), encryption indicators
- **Transform:** Conversation list → Thread list, Message bubbles → Thread cards
- **Add:** Thread composer (title + body), Reply composer, Orbit selector
...
- Frontend architecture: `/orbital-docs/frontend-architecture.md`
- WebSocket & real-time: `/orbital-docs/websocket-realtime.md`
- API specification: `/orbital-docs/api-specification.md`
