    ...
    >(() => {
      ...
      return [
        ...
        [
          ...
          '#000000',
          'M17.49 14.775 23.313 8h-1.38l-5.058 5.883L12.836 8h-4.66l6.109 8.895L8.176 24h1.38l5.342-6.212L19.165 24h4.659zm-1.892 2.2-.62-.887-4.923-7.048h2.12l3.975 5.688.618.887 5.166 7.393h-2.12z',
