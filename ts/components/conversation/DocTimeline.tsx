...
> {
  ...
  public override componentDidMount(): void {
    ...
    if (
      !this.props.messageLoadingState &&
      !this.props.haveOldest
      // oldestPartiallyVisibleMessageId &&
      // oldestPartiallyVisibleMessageId === items[0]
    ) {
      this.props.loadOlderMessages(this.props.id, this.props.items[0]);
    }
  }
  ...
  public override componentDidUpdate(
    ...
    if (haveItemsChanged) {
      ...
      const numberToKeepAtBottom = this.maxVisibleRows * 200000;
      ...
      const loadingStateThatJustFinished:
        ...
        !messageLoadingState && previousMessageLoadingState
          ...
          : undefined;
      const numberToKeepAtTop = this.maxVisibleRows * 50000;
