...
const TEST_VECTORS: string[][] = [
  ...
  ["https://fake.invalid/blasdflkjasdf?igshid=192u34oijserr", "https://fake.invalid/blasdflkjasdf"],
  ...
  ["https://em.dynamicyield.com/foo/bar?cuid=baz", "https://em.dynamicyield.com/foo/bar?cuid=baz"],
];
